 ...
 */
package com.codelouders.shmetterling.database

import com.codelouders.shmetterling.entity.{JsonNotation, BaseEntity}
import com.codelouders.shmetterling.rest.UpdateException
import com.codelouders.shmetterling.util.SqlUtil
